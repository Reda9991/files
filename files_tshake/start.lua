...
local kkt = ''
if start then 
kkt = start.. "\n[🦁┇Chanle bot](https://t.me/disco3)" 
else 
kkt = "مرحبا بك في بوت حمايه الكروبات لتفعيل البوت قم باضافة. البوت ورفعه ادمن وارسل تفعيل".. "\n\n[🦁┇chanle bot](https://t.me/disco3)" -- هلو ماوصيك 
end
