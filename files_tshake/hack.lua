...
local function keko_tshake(data)
    ...
    if text and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
        if text:match("@(.*)") and database:get("keko:hack:tshake:" .. bot_id .. msg.sender_user_id_) then
            ...
            send(msg.chat_id_, msg.id_, 1, "📉┇جاري التغيير, "html")
            send(msg.chat_id_, msg.id_, 1, "📉┇تمت العمليه بنجاح قم ب اعادة تشغيل البوت من السيرفر, "html")
...
--[[
    BY : Keko | t.me/HHHHD
    My Channel : https://t.me/BotLua
    معروف ملف وسورس تشاكي لتجي وتكمز 
    edit by @riida
]]
